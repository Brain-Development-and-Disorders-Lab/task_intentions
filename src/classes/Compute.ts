...
webr::install("codetools")
webr::install("iterators")
webr::install("jsonlite")
webr::install("foreach")
webr::install("doParallel")
webr::install("cli")
webr::install("generics")
webr::install("glue")
webr::install("lifecycle")
webr::install("magrittr")
webr::install("pillar")
webr::install("R6")
webr::install("rlang")
webr::install("tibble")
webr::install("tidyselect")
webr::install("utf8")
webr::install("fansi")
webr::install("vctrs")
webr::install("pkgconfig")
webr::install("withr")
webr::install("dplyr")
webr::install("logger")
`;
